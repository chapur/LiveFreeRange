<%@ Page Language="C#" AutoEventWireup="true" CodeFile="UnSubscribe.aspx.cs" Inherits="Admin_UnSubscribe" Title="Admin Control Panel | Unsubscribe" %>
                            ...
                            <table width="470" height="100%" border="0" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td height="164" align="left" valign="top" background="../images/top_1.jpg">
                                        <div style="padding-left: 156px; padding-top: 69px">
                                            <img src="../images/logo.jpg" width="159" height="36" border="0"><br />
                                            &nbsp;</div>
                                    </td>
                                </tr>
                                <tr>
                                        ...
                                        <table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0" background="../images/rep_3.jpg">
                                            <tr align="left" valign="top">
                                                <td background="../images/rep_left.jpg" style="width: 10px">
                                                    <img src="../images/rep_left.jpg" width="10" height="1">
                                                </td>
                                                <td height="100%">
                                                    <table width="450" height="100%" border="0" cellpadding="0" cellspacing="0">
                                                        <tr align="left" valign="top">
                                                            <td background="../images/rep_line.jpg" bgcolor="#F3E9BF" style="background-repeat: repeat-y;
                                                                ...
                                                                &nbsp;<br />
                                                                <strong>Unsubscribe From Newsletter</strong><br />
                                                                        ...
                                                                        <td align="center" valign="top">
                                                                            ...
                                                                            <table border="0" cellpadding="3" cellspacing="0" style="width: 360px">
                                                                                <tr>
                                                                                    <td>
                                                                                        Dear
                                                                                        <asp:literal id="litName" runat="server"></asp:literal>, you have been successfully
                                                                                        removed from the newsletter mailing list.
                                                                                    </td>
                                                                                </tr>
                                                                            </table>
                                                                        </td>
                                                ...
                                                <td width="10" background="../images/rep_right.jpg">
                                                    <img src="../images/rep_right.jpg" width="10" height="1">
                                                </td>
                                            </tr>
                                            <tr>
                                                <td colspan="3" valign="top" align="center">
                                                    <img src="../images/bottom_1.jpg" width="470" height="23">
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
        ...
        <tr>
            ...
            <td height="100%">
                <table cellpadding="0" cellspacing="0" border="0" width="100%" height="100%">
                    <tr>
                        <td style="height: 100%; background-image: url(../images/rep_bot.jpg); background-repeat: repeat-y;
